...
<template>
  ...
  <div class="content mt-5">
    <h2 class="mt-10 text-lg font-medium intro-y" id="head_text">
      รายการแจ้งชำระเงิน
    </h2>
                ...
                <table class="table table-striped">
                  <thead>
                    <tr>
                      ...
                      <th class="whitespace-nowrap text-left">
                        <span style="display: block; width: 150px">ชื่อ-สกุล</span>
                      </th>
                      <th class="whitespace-nowrap text-left">
                        <span style="display: block; width: 100px"> เบอร์โทร </span>
                      </th>
                      <th class="whitespace-nowrap text-left">
                        <span style="display: block; width: 200px">รายการ</span>
                      </th>
                      <th class="whitespace-nowrap" style=" width: 90px">สถานะ</th>
                      <th class="whitespace-nowrap" style=" width: 120px">ช่องทางการชำระ</th>

                      <th class="whitespace-nowrap" style=" width: 90px">ยอดรวม</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="whitespace-nowrap text-left">
                        <span style="display: block; width: 150px">สมหญิง จริงจริงนะ</span>
                      </td>
                      <td class="whitespace-nowrap text-left">
                        <span style="display: block; width: 100px">091-111-1111	</span>
                      </td>
                      <td class="whitespace-nowrap text-left">
                        <span style="display: block; width: 200px;">อัปเกรดแพคเกจ M</span>
                      </td>
                      <td class="whitespace-nowrap" style=" width: 90px"> <p class="bg-success text-white rounded-md">
                          ชำระเเล้ว
                        </p></td>
                      <td class="whitespace-nowrap" style=" width: 120px">โอนผ่านธนาคาร</td>

                      <td class="whitespace-nowrap" style=" width: 90px">ยอดรวม</td>
