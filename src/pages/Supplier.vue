    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
      ...
      >
        ...
        <Button
          ...
          class="ml-3 mr-2 shadow-md bg-[#af0000] text-white"
      ...
      <div class="col-span-12 overflow-auto intro-y lg:overflow-visible">
        ...
        <div class="">
          <div class="">
            <select name="" id="" class="w-56 mr-2 forminput">
              <option value="">เลือกทำทั้งหมด</option>
              <option value=""><button>ลบรายการ</button></option>
            </select>
          </div>
          <div class="">
            <a href="addsupplier">
        ...
        <table class="table table-striped">
          <thead>
            <tr>
              ...
              <th class="whitespace-nowrap"><button>ชื่อ</button></th>
              <th class="whitespace-nowrap"><button>อีเมล</button></th>
              <th class="whitespace-nowrap">
                <span><button>เบอร์โทร</button></span>
              </th>
              <th class="whitespace-nowrap"><button>วันที่สร้าง</button></th>
              <th class="whitespace-nowrap"><button>จัดการ</button></th>
            </tr>
          </thead>
