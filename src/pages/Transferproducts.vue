...
<template>
  <!-- BEGIN: Content -->
  <div class="content">
    <h2 class=" text-lg font-bold intro-y" id="">โอนสินค้า</h2>
    <br />
    <hr />
    <br />
    <h3 style="font-weight: bold">รายการโอนสินค้า</h3>
        ...
        <div class="w-full mt-3 sm:w-auto sm:mt-0 sm:ml-auto md:ml-0">
          ...
          <div class="relative text-slate-500" id="input_search">
            <FormInput
              ...
              placeholder="ค้นหาด้วยหมายเลขการโอนสินค้า"
              id="categories"
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th>รูปภาพ</th>
              <th>หมายเลขการโอนสินค้า</th>
              <th>หมายเหตุ</th>
              <th>คลังสินค้าต้นทาง</th>
              <th>คลังสินค้าปลายทาง</th>
              <th>ผู้โอน</th>
              <th>ผู้ยืนยัน</th>
              <th>สถานะ</th>
              <th>วันที่สร้าง</th>
