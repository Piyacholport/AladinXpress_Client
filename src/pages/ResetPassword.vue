      ...
      <div class="block grid-cols-2 gap-4 xl:grid">
        ...
        <div class="flex h-screen py-5 my-10 xl:h-auto xl:py-0 xl:my-0">
          ...
          >
            ...
            <div class="flex items-center mr-auto mt-1 ">
              <p class="text-s">กรุณากรอกรหัสผ่านใหม่</p>
              </div>
            <div class="mt-8 intro-x">
              ...
              <InputGroup class="">
                ...
                v-if="showPassword"
                  v-model="newpassword"
                type="text"
                class="block px-4 py-3 mt-4  xl:min-w-[350px]"
              ...
              />
                ...
                <InputGroup.Text @click="toggleShow"
              ...
              <InputGroup >
                ...
                <InputGroup.Text @click="toggleShowconfirm"
                  id="input-group-price"
                  class="block px-4 py-3 mt-4 cursor-pointer"
                >
                  <Lucide icon="Eye" class="w-4 h-4 "
            ...
            >
              ...
              <!-- <a class="text-[#af0000]" href="">ลืมรหัสผ่าน?</a> -->
            </div>
            ...
            >
              <Dialog.Panel>
                <div class="p-5 text-center">
                  ...
                  />
                  <div class="mt-5 text-3xl">สำเร็จ</div>
