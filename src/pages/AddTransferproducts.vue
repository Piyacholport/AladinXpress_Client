          ...
          <div class="p-5 intro-y box">
            ...
            >
              ...
              <div class="forminput">
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2 mt-2" id="label">
                    <span class="text-right"><span class="text-danger text-l font-bold">* </span>โอนไปยัง :</span>
                  </div>
                  <div class="col-end-7 col-span-5" id="bdred">
                    <div class="">
                      <FormSelect v-model="categoryId" id="">
                        <option value="">My WareHouse2</option>
                        <!-- <option
                              id="when_hover"
                              v-for="(item, index) in categories"
                              :key="index"
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2 mt-2" id="label">
                    <span class="text-right"><span class="text-danger text-l font-bold">* </span>วันที่โอนสินค้า :</span>
                  </div>
                  <div class="relative w-56 mx-auto ml-3">
                    <div
