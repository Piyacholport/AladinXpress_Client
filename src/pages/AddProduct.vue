            ...
            >
              ...
              <div class="">
                ...
                <div v-if="selectedProductType == 'CONFIG'">
                  <div class="grid grid-cols-6 gap-4">
                    <div class="col-start-1 col-end-2 ..." id="label">
                      <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>ชื่อคุณสมบัติ :</span>
                    </div>
                    <FormSelect
                  ...
                  <div v-if="allProductFeature[0]">
                    <div class="grid grid-cols-6 gap-4">
                      <div class="col-start-1 col-end-2 ..." id="label">
                        <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>ตัวเลือกคุณสมบัติ :</span>
                      </div>
                      ...
                      >
                        <option
                          v-for="item in allProductFeature[parseInt(selectedProductFeatureIndex)]?.productFeatureList"
                          :key="item.id"
                          :value="item"
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2" id="label">
                    <span class="text-right"><span class="text-danger text-l font-bold">* </span>ชื่อสินค้า :</span>
                  </div>
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2 ..." id="label">
                    <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>รหัสสินค้า :</span>
                  </div>
                  <div class="col-end-7 col-span-5 ..." id="bdred">
                    <div class="">
                      <FormInput
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2 ..." id="label">
                    <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>บาร์โค้ดสินค้า :</span>
                  </div>
                  <div class="col-end-7 col-span-5 ..." id="bdred">
                    <FormInput
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2 ..." id="label">
                    <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>รูปภาพ :</span>
                  </div>
                  <div class="col-end-7 col-span-5 ..." id="bdred">
                ...
                <div class="grid grid-cols-6 gap-4">
                  <div class="col-start-1 col-end-2 ..." id="label">
                    <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>หมวดหมู่ :</span>
                  </div>
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>แบรนด์ :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="brand"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>น้ำหนัก (กรัม) :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="weight"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>ยาว (มม) :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="length"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>กว้าง (มม) :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="width"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>สูง​ (มม) :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="height"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>คะแนนสะสม :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="point"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>รายละเอียดสินค้า (ย่อ) :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>รายละเอียดสินค้า :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
        ...
        <div class="p-5 intro-y box">
          <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400">
            ...
            <div class="">
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>ต้นทุน :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="unitCost"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>ราคาต่อหน่วย :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="unitPrice"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">*</span>จำนวนสินค้า :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="QTY"
              ...
              <div class="grid grid-cols-6 gap-4">
                <div class="col-start-1 col-end-2 ..." id="label">
                  <span class="text-right ..."><span class="text-danger text-l font-bold">* </span>สินค้าคงคลังขั้นต่ำ :</span>
                </div>
                <div class="col-end-7 col-span-5 ..." id="bdred">
                  <FormInput
                    v-model="safetyStock"
  ...
  methods: {
    ...
    async getAllWarehouse() {
      try {
        ...
        const URL =  
          `${import.meta.env.VITE_API_URL}/warehouse/getAllWarehouse`.replace(
          " ",
          ""
        );
    ...
    async getAllCategory() {
      try {
        ...
        const URL =  
          `${import.meta.env.VITE_API_URL}/category/search?categoryName=&category=all`.replace(
          " ",
          ""
        );
        const headers = {
    ...
    async addProduct() {
      try {
        ...
        if (this.selectedProductType == "CONFIG") {
          formData.append("productFeatureId", this.allProductFeature[parseInt(this.selectedProductFeatureIndex)].id);
          formData.append("productFeatureValue", this.selectedProductFeatureValue as string);
        }
        ...
        const URL =   `${import.meta.env.VITE_API_URL}/product/addProduct`.replace(" ","");
        const response = await axios.post(URL,
          formData,
          {
            headers: {
