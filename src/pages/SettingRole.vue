...
<template>
  <!-- BEGIN: Content -->
  <div class="content">
    <h2 class="text-lg font-bold intro-y" id="">สิทธิ์ผู้ใช้งาน</h2>
    <br /><br />
    <Button as="a" href="setting-role-detail" class="inline-block" id="goldgd">
      <div class="flex items-center justify-center mt-1">
        <span class="flex items-center justify-center w-5 h-5">
          <Lucide icon="PlusCircle" class="w-4 h-4 mt-1" />
        </span>
        <span>สร้างสิทธิ์ผู้ใช้งาน</span>
      </div>
    </Button>
    <br /><br />
    <div class="">
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>ฝ่ายจัดการ</td>
            <td class="text-left">
              ฝ่ายจัดการ มีสิทธิ์รองจากเจ้าของร้าน สามารถตั้งค่าต่างๆของระบบ
            </td>
            <td>
              <Button
                as="a"
