...
function CheckPassword(inputtxt: any) {
    ...
    <div class="container relative z-10 sm:px-10">
      <div class="block grid-cols-2 gap-4 xl:grid">
        ...
        <div class="flex-col hidden min-h-screen xl:flex ml-0">
          ...
          <div class="ml-1">
            <br><br>
            <img alt="Midone Tailwind HTML Admin Template" class="  -intro-x ml-10 mt-5 "
              src="..//assets/images/aladin.png" width="200px" style="margin-left:15%" />
            <div class="mt-5 text-4xl font-medium leading-tight text-white -intro-x">
              ลงทะเบียนอะลาดิน เอ็กซ์เพรส <br />
        ...
        <!-- END: Login Info -->
        <!-- BEGIN: Login Form -->
        <div class="overflow-y-scroll xl:h-[600px] sm:h-full">
          <div
            ...
            <div class="mt-8 ">
              ...
              <FormSelect v-model="selectedPackage" id="package"
                class="block px-4 py-3 mb-4 intro-x login__input min-w-full xl:min-w-[400px]">
              ...
              <FormInput v-model="firstName" type="text"
                class="block px-4 py-3 mt-4 intro-x login__input w-full xl:min-w-[350px]" placeholder="ชื่อ" />
